...
public class GsmSender {
     ...
     */
    public GsmSender(String apiKey) {
        this(apiKey, 10);
    }
     ...
     */
    public GsmSender(String apiKey, int retryCount) {
        this(apiKey, retryCount, PRODUCTION_URL);
    }

    @VisibleForTesting
    public GsmSender(String apiKey, int retryCount, String url) {
